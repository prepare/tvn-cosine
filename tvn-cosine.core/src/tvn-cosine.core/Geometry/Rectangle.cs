namespace tvn.cosine.Geometry
{
    ...
    public class Rectangle : IRectangle
    {
        ...
        public IRectangle Intersection(IRectangle rectangle)
        {
            ...
            {
                int x = tvn.cosine.Math.Max(this.X, rectangle.X);
                int y = tvn.cosine.Math.Max(this.Y, rectangle.Y);
                long x2 = tvn.cosine.Math.Min(this.X2, rectangle.X + rectangle.Width);
                long y2 = tvn.cosine.Math.Min(this.Y2, rectangle.Y + rectangle.Height);
        ...
        {
            int x = tvn.cosine.Math.Min(X, rectangle.X);
            int y = tvn.cosine.Math.Min(Y, rectangle.Y);
            long x2 = tvn.cosine.Math.Max(X2, rectangle.X + rectangle.Width);
            long y2 = tvn.cosine.Math.Max(Y2, rectangle.Y + rectangle.Height);
            uint width = (uint)(x2 - x);
            uint height = (uint)(y2 - y);
